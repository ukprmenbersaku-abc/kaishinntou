...
export const members: Member[] = [
  ...
  },
  {
    ...
    detailBio: '元芳川小給食委員長。幼い頃からプログラミングやシステム構築に興味を持ち、独学で知識を深めてきました。感情論ではなく、データや仕組みで物事を解決することを得意としています。「不便さ」をデジタルの力で「快適さ」に変えるアイデアを常に持っており、岩本の掲げる理想を現実的なプランに落とし込む役割を担っています。冷静沈着ですが、学校を良くしたいという情熱は人一倍です。',
