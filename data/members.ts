...
export const members: Member[] = [
  ...
  },
  {
    ...
    name: '林 佑奈',
    role: '共同代表代行 (1年3組)',
    bio: '代表・共同代表を支え、女子生徒の視点からきめ細やかな意見を提案するサブリーダー。',
    image: 'images/hayashi.png',
    detailBio: '1年3組。岩本、Sとはクラスメイトであり、二人の極端な意見をうまく中和してまとめる調整役。男子ばかりになりがちな議論において、女子生徒の視点や、生活面の細かな気づきを反映させる役割を担う。真面目で信頼が厚い。',
    message: '大きな改革も大切ですが、毎日の学校生活の「ちょっとした不便」を解消することも大切だと思っています。皆さんが安心して過ごせる学校になるよう、代表たちをしっかりサポートしていきます。',
    tags: ['#調整役', '#女子視点', '#しっかり者', '#サポート'],
  ...
  },
  {
    ...
    name: '高橋 健人',
    role: '幹事長 (1年2組)',
    bio: '党の実務を取り仕切る司令塔。スケジュールの管理や他委員会との折衝を担当する。',
    image: 'images/takahashi.png',
    detailBio: '1年2組。冷静かつ論理的な思考の持ち主で、岩本代表の熱いビジョンを具体的なスケジュールやタスクに落とし込む実務の責任者。会議の進行や、資料作成の指揮を執り、党の活動が円滑に進むよう裏方として支えている。',
    message: '理想を語るだけでは現実は変わりません。どうすれば実現できるか、徹底的に計画を練るのが私の仕事です。確実に成果を出せる生徒会を目指します。',
    tags: ['#実務派', '#スケジュール管理', '#論理的', '#司令塔'],
  ...
  },
  {
    ...
    name: '西村 大樹',
    role: '選挙対策委員長 (1年1組)',
    bio: '選挙戦略の立案と広報活動の指揮を執る。ポスター制作や演説のプロデュースを行う。',
    image: 'images/nishimura.png',
    detailBio: '1年1組。トレンドに敏感で、どうすれば想いが伝わるかを常に考えている広報のスペシャリスト。ポスターのデザインや、演説での言葉選びなど、改新党のイメージ戦略を一手に引き受けている。クラスのムードメーカーでもある。',
    message: '政治って難しそう、というイメージを変えたいです。私たちのワクワクするような計画を、みんなに分かりやすく伝えていきます！ポスターや動画も楽しみにしていてください。',
    tags: ['#広報戦略', '#アイデアマン', '#ムードメーカー', '#トレンド'],
