...
export const members: Member[] = [
  ...
  },
  {
    ...
    message: '代表 岩本を支え、みんなが活動しやすい環境を作っていきます。よろしくお願いします。',
    tags: ['#新任', '#責任感', '#幹事長'],
  ...
  },
  {
    ...
    name: 'T.K',
    role: '政調会長',
    bio: '政策の立案 and 具体化を担当。公約実現のキーマン。',
    image: '',
  ...
  },
  {
    ...
    message: '改新党の公式サイトを見ていただきありがとうございます。このサイトを通じて、改新党の活動をより深く知いただければ幸いです。',
    tags: ['#Web担当', '#デザイン', '#裏方'],
    color: 'bg-stone-100 text-stone-700'
  }
];