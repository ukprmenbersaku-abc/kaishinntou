...
export const members: Member[] = [
  {
    ...
    message: '筑摩野改新党を立ち上げるさいの、皆さんのご協力に感謝しています。私は、筑摩野中学校を皆が楽しく、「筑中に来てよかった。」と思える学校にする。その強い志があります。その志を実現するには、皆さんのご協力が必要です。どうか、皆さんのご協力をお願いします。皆さんと一緒に「誇りの持てる筑中」を作りましょう！',
